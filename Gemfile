...
gem 'mail', '~> 2.7.1' # pin before net-imap/date native-ext chain (Ruby 2.7 compat)
gem 'mail_form', '~> 1.8.0' # send e-mail straight from forms in Rails.
...
gem 'simple_form', '~> 5.1.0' # forms made easy for Rails!
